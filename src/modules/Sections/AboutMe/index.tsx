...
import { useHeroTransitionAnimation } from '../hooks/useHeroTransitionAnimation';
import { useTypeWritingAnimation } from '../hooks/useTypeWritingAnimation';
import { ScrollIcon } from './ScrollIcon';

const AboutMe = () => {
  useTypeWritingAnimation();
  useHeroTransitionAnimation();
  return (
    <section className="grid grid-cols-3 grid-rows-section h-full w-full shrink-0 sections " id="about-me-section">
      <div className="col-start-1 row-start-1 text-soft-white ms-24 self-center hero-name font-semibold">
